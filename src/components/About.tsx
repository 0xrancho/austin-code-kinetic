    ...
    <section id="about" className="py-20 relative texture-bg">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-primary after:content-[''] after:block after:w-16 after:h-1 after:bg-primary/20 after:mt-4">
            About Joel
          </h2>
          
          <div className="prose prose-invert prose-lg max-w-none mb-12">
            <p className="text-primary/80 mb-6 leading-relaxed max-w-[700px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-primary/5 border border-primary/10 rounded-lg p-6 transition-transform hover:transform hover:-translate-y-1 duration-300">
              <User className="w-10 h-10 mb-4 text-primary/70" />
              <h3 className="text-xl font-bold mb-2">Personal</h3>
              <p className="text-primary/70">Father of five with a passion for technology and innovation.</p>
            </div>
            
            <div className="bg-primary/5 border border-primary/10 rounded-lg p-6 transition-transform hover:transform hover:-translate-y-1 duration-300">
              <Code className="w-10 h-10 mb-4 text-primary/70" />
              <h3 className="text-xl font-bold mb-2">AI Enablement</h3>
              <p className="text-primary/70">Building solutions that leverage AI to solve real-world business challenges.</p>
            </div>
            
            <div className="bg-primary/5 border border-primary/10 rounded-lg p-6 transition-transform hover:transform hover:-translate-y-1 duration-300">
              <FileText className="w-10 h-10 mb-4 text-primary/70" />
              <h3 className="text-xl font-bold mb-2">RevOps</h3>
              <p className="text-primary/70">Optimizing revenue operations through strategic alignment and process improvement.</p>
            </div>
          </div>
        </div>
      </div>
