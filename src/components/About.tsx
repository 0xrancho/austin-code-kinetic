        ...
        <div className="content-box w-full mx-auto p-12 md:p-16">
          ...
          <div className="prose prose-invert prose-lg max-w-none mb-12">
            <p className="text-white/90 mb-6 leading-relaxed">
              ...
              Now I deploy lightweight, modular, AI-first tools that automate qualification, accelerate success, and generate lift without bloated overhead. LLMs have collapsed the SDLC. AI enabled Sales Ops isn't just dashboards and pipelines anymore—it's growth architecture, and I'm here to build it.
            </p>
          </div>
        </div>
      </div>
