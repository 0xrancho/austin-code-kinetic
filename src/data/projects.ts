...
const projects: Project[] = [
  {
    ...
    details: "ProofStack – Social Proof Engine for Outbound Sales Velocity\nProofStack began as a 24-hour build challenge — and turned into one of the most immediately validated tools I've ever prototyped.\n\nA sales manager, frustrated that his SDRs were missing quota because they were spending too much time researching before calls, reached out through a mutual friend. The pain was clear:\n\n\"They don't know what to say — or who to connect it to.\"\n\nThe solution was obvious: retrieval-augmented generation (RAG) powered by internal proof.\n\nProofStack ingests your customer success stories, buyer personas, and current customer product data. It then cross-references that against inferred lead profiles (via Apollo API), analyzing sub-industry, size, geography, and segment. It automatically returns high-authority, high-relevance proof points that match the lead — eliminating the research phase entirely.\n\nHow it works:\n• SDR types in a company name\n• ProofStack matches them to similar wins\n• It generates a short, trust-building message or call opening line\n• The rep dials — with zero prep and full context\n\nProjected impact (from user demos):\n• +10% outbound velocity\n• +10% conversion from connect to opportunity\n• +10% reduction in new rep onboarding time\n• +10% lift in mid-cycle upsell when layered into AM workflows\n\nCurrent stage:\n• Prototypes demoed to 6 enterprise teams\n• 5 expressed intent to buy today at price points near $3,500/seat\n• Goal is to gather LOIs and refine GTM motion before investing in standalone MVP\n\nProofStack isn't just a research killer — it's a trust shortcut. It brings social proof to the top of the funnel, right where confidence and context matter most.",
