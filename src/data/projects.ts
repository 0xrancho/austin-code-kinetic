...
const projects: Project[] = [
  ...
  }, 
  {
    ...
    description: "Turning Customer Data into Growth Strategy", 
    details: "Big Loud Shirt – Turning Customer Data into Growth Strategy\nA Sales-Ready Segmentation Engine for Non-Technical Teams\nBig Loud Shirt is a generative analytics tool designed for DTC businesses with strong customer data but no easy way to act on it. It converts historical customer behavior into goal-driven segments and campaign-ready strategies — no queries, dashboards, or data teams required.\n💬 \"We've got the data — we just can't use it without a data team.\"\nBig Loud Shirt gives revenue teams the power to explore buyer segments by objective, tactic, products, and location to visualize engagement patterns in real time, and auto-generate campaigns that would otherwise take weeks of analyst support.\n\n🛠️ Key Features\nGoal-Based UX – Winback, Expand, Advocate: choose the growth motion\n\nTactic-Aware Prompting – Smart prompt logic adapts to your play\n\nSegment Visualizer – Interactive sunburst with refinement sliders for GPT_BIN, churn, region, and category\n\nAI Campaign Builder – Every segment includes messaging ideas, target channels, and reach estimates.\n\n🚀 What Makes It Work\nBig Loud Shirt doesn't summarize data — it converts it into growth strategy.\nIt generates campaign-ready customer segments, tailored to specific GTM goals, with embedded engagement plans and activation tactics.\nIt puts the power of ML-tier segmentation into the hands of marketers and GTM operators — no dashboards, no SQL, no translation layers.\nIt's not a BI tool. It's a revenue interface, built to get from dataset to deployable campaign in a single session.\nAlso, yes — the logo is a Picasso-style guy in marching band pants and a Hawaiian shirt carrying a bass drum. Because data shouldn't be quiet.",
